...
export default function IndexPage() {
    ...
    const handleBtn = (e) => {
        setInputForm(Object.assign(Object.assign({}, inputForm), { [e.target.name]: e.target.value }));
    };
    ...
    const handleSubmit = (e) => __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            yield axios.get("/api/products", { params: inputForm }).then((res) => {
                if (res.status === 200) {
                    router.push({
    ...
    return (<div className="container w-full mx-auto text-center mb-24">
      <h1 className="pb-20 font-light text-xl md:text-2xl lg:text-3xl">
        나에게 어울리는 칵테일은 ?
      </h1>
      <form onSubmit={(e) => handleSubmit(e)} className="mx-auto w-5/6 flex flex-col text-center items-center">
        <div className="relative h-4 w-4/5 rounded bg-black">
          <label htmlFor="alcohol" className="invisible">
            Alcohol
          </label>
          <input type="range" className="RangeBar" id="alcohol" name="alcohol" max={100} min={0} step="10" value={inputForm.alcohol} onChange={(e) => handleBtn(e)}/>
        ...
        <div className="relative h-4 w-4/5 rounded bg-black mt-20">
          ...
          <input type="range" className="RangeBar" id="sugar" name="sugar" max={100} min={0} step="10" value={inputForm.sugar} onChange={(e) => handleBtn(e)}/>
        ...
        <div className="relative h-4 w-4/5 rounded bg-black mt-20">
          ...
          <input type="range" className="RangeBar" id="sourness" name="sourness" max={100} min={0} step="10" value={inputForm.sourness} onChange={(e) => handleBtn(e)}/>
        ...
        <div className="relative h-4 w-4/5 rounded bg-black mt-20">
          ...
          <input type="range" className="RangeBar" id="bitter" name="bitter" max={100} min={0} step="10" value={inputForm.bitter} onChange={(e) => handleBtn(e)}/>
