...
const CocktailOfToday = () => {
    ...
    return (<div className="h-4/5 font-light m-auto mb-10 mt-6 p-14 text-center">
      ...
      <Image alt="네그로니" src="/img/todayscocktail.png" width="250" height="250" className="mx-auto"/>
      ...
      <div className="lg:w-3/5 mx-auto py-10">
        ...
        <ul className="flex flex-row justify-center py-6">
          <li className="mx-2">
            <Image src="/img/ice.png" width="75" height="70" alt="ice" className="w-auto h-auto"/>
          </li>
          <li className="mx-3">
            <Image src="/img/orange.png" width="65" height="75" alt="orange" className="w-auto h-auto"/>
          </li>
          <li className="mx-4">
            <Image src="/img/campari.png" width="30" height="80" alt="campari" className="w-auto h-auto"/>
          </li>
          <li className="mx-3">
            <Image src="/img/jin.png" width="50" height="68" alt="jin" className="w-auto h-auto"/>
          </li>
          <li className="mx-3">
            <Image src="/img/sweet.png" width="50" height="68" alt="sweet" className="w-auto h-auto"/>
          </li>
        </ul>
