...
const Footer = () => {
    return (<div className="footer_container relative bottom-0">
      ...
      <div className="mt-16 mb-5">
        ...
        <input className="w-1/4 mb-8 mt-5 outline-none p-2 md:p-3 lg:p-3 text-sm md:text-base lg:text-base xl:text-base" placeholder="Your email address .."/>
